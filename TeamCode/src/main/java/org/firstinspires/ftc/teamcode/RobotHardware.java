...
public class RobotHardware {
    ...
    private final double[] cellOpenPositions = new double[]{0.768, 0.486, 0.7975}; //ups
    private final double[] cellClosedPositions = new double[]{1.000, 0.709, 0.746}; //downs
    ...
    public void init() {
        ...
        cellManager = new ArtifactCellManager(
                cellOpenPositions, //ups
                cellClosedPositions, //downs
                leftColorSensor,
                centerColorSensor,
                rightColorSensor,
                leftCell,
