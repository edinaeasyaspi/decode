...
public class RobotAutoDriveToAprilTagOmni extends LinearOpMode
{
    ...
    final double MAX_AUTO_SPEED = 0;  //  Clip the approach speed to this max value (adjust for your robot)
    final double MAX_AUTO_STRAFE= 0;   //  Clip the strafing speed to this max value (adjust for your robot)
    ...
    @Override public void runOpMode()
    {
        ...
        frontLeftDrive = hardwareMap.get(DcMotor.class, "MotorTwo");
        frontRightDrive = hardwareMap.get(DcMotor.class, "MotorOne");
        backLeftDrive = hardwareMap.get(DcMotor.class, "MotorFour");
        backRightDrive = hardwareMap.get(DcMotor.class, "MotorThree");
